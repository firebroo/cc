...
void
httpClient::handle_resolve(const boost::system::error_code& err,
...
bool 
httpClient::verify_certificate(bool preverified,
...
void 
httpClient::handle_connect(const boost::system::error_code& err)
{
    if (!err) {
...
void 
httpClient::handle_handshake(const boost::system::error_code& error)
{
    if (!error) {
...
void 
httpClient::handle_write_request(const boost::system::error_code& err)
{
    if (!err) {
...
void 
httpClient::handle_read_status_line(const boost::system::error_code& err)
{
    if (!err) {
...
void 
httpClient::handle_read_headers(const boost::system::error_code& err)
{
    if (!err) {
...
void 
httpClient::handle_read_content(const boost::system::error_code& err)
{
    if (!err) {
